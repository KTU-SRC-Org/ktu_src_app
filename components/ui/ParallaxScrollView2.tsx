...
export const blurhash =
  '|rF?hV%2WCj[ayj[a|j[az_NaeWBj@ayfRayfQfQM{M|azj[azf6fQfQfQIpWXofj[ayj[j[fQayWCoeoeaya}j[ayfQa{oLj?j[WVj[ayayj[fQoff7azayj[ayj[j[ayofayayayj[fQj[ayayj[ayfjj[j[ayjuayj[' as string;
...
const ParallaxScrollView = ({ children }: PropsWithChildren) => {
  ...
  const headerAnimatedStyle = useAnimatedStyle(() => {
    ...
    const scale =
      scrollOffset.value <= 0 ? interpolate(scrollOffset.value, [-HEADER_HEIGHT, 0], [2, 1]) : 1; // no scaling when scrolling up
      ...
      <Animated.ScrollView
        ...
        <View style={styles.headerContainer}>
          ...
          <View>
            ...
            <View className="relative flex h-full w-full  flex-row pt-10">
              <Image
