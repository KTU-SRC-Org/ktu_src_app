...
export const Card = ({ item, onPress }: Props) => {
  return (
    <Pressable
      ...
      onPress={onPress}>
      <View className="absolute z-50 flex flex-row items-center p-1 px-2 rounded-full right-5 top-5 bg-white/90">
      ...
      <Image source={{ uri: item.image ?? 'https://images.unsplash.com/photo-1555854877-bab0e564b8d5?w=400' }} className="w-full h-40 rounded-lg" />
