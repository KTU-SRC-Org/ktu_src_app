...
const dummyNotifications: NotificationData[] = [
    ...
    },
    {
        ...
        timestamp: '5h ago',
        description: 'Join us for the annual Tech Summit featuring industry leaders, workshops, and networking opportunities. Register now to secure your spot for this exciting event...',
        avatarFallback: 'CS',
    ...
    },
    {
        ...
        timestamp: '1d ago',
        description: 'Great news! The main library will now be open 24/7 during exam periods. Access your study materials and resources anytime you need them...',
        avatarFallback: 'LIB',
    ...
    },
    {
        ...
        timestamp: '2d ago',
        description: 'Sign up for the annual inter-department sports competition. Multiple categories available including football, basketball, athletics, and more...',
        avatarFallback: 'SPT',
    ...
    },
    {
        ...
        timestamp: '3d ago',
        description: 'Exciting news! A new food court with diverse cuisine options is opening next to the Student Center. Grand opening with special discounts this Friday...',
        avatarFallback: 'FC',
