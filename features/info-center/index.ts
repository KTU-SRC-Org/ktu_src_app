...
export const infoData: InfoDetailsInterface[] = [
  ...
  },
  {
    ...
    message: 'Celebrate SRC Week with a night of music, dance, and culture at the KTU Forecourt.',
    type: 'announcement',
    ...
    headsUp: 'Expect high winds; avoid using light tents. Bring jackets for the evening breeze.',
  ...
  },
  {
    ...
    message: 'The campus library will now close at 10:00 PM on weekdays during the exam season.',
    type: 'announcement',
  ...
  },
  {
    ...
    message: 'Campus offices will remain closed during the national holiday next week.',
    type: 'announcement',
