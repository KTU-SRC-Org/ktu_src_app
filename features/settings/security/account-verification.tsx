    ...
    <ScrollView
      ...
      <View className="flex-col gap-4">
        <View className={'w-full flex-col gap-2'}>
          ...
          <Text className="text-start text-base leading-6 text-neutral-500">
            Here are the details linked to your verified account. They help protect your identity
            and ensure your account remains secure. We never share this information with anyone.
          </Text>
        </View>
        <View className="flex-col gap-4">
          <VerifiedInput
