        ...
        <View className="flex-1 justify-center">
          {step === STEPS.OLD ? (
            <View className="w-full flex-col">
              <Text className="text-lg text-start font-semibold">Enter your old password</Text>
            ...
            <View className="w-full flex-col gap-4">
              <Text className="text-lg text-start font-semibold">Set your new password</Text>
